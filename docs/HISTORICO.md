# MilScale — histórico de entregas

Registro de cada rodada de desenvolvimento, na ordem em que foi escrito.
Movido do README em 25/09/2026 (Plano 1, Task 10) sem alterar o texto —
o manual de uso e instalação ficou no [README](../README.md).
